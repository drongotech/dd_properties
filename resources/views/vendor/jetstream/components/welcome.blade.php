...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laravel.com/docs">Payment Receipts</a></div>
        </div>
        ...
        <div class="ml-12">
            ...
            <a href="{{ route('payment_receipts') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>View Reciepts</div>
